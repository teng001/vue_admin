...
class UploadService
{
     ...
     * @throws UploadException
     */
    public function upload($inputFileName = 'filedata', array $options = [],$imageModel='')
    {
    ...
    protected function saveFile(UploadedFile $file, $uploadDirectoryRelativePath)
    {
        ...
        //如果是pptx则使用 默认扩展名
        if ($file->getClientOriginalExtension() == 'ppt' || $file->getClientOriginalExtension() == 'pptx') {
            $fileExtension = $file->getClientOriginalExtension();
        }
        $filename = $this->getRandomFilename($fileExtension);
