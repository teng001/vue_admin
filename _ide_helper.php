 ...
 * Generated for Laravel 5.1.45 (LTS) on 2017-04-17.
 *
...
namespace {
    ...
    class Eloquent extends \Hbclare\ModelHelper\Model{
        ...
        public static function setHelperModel($model){
            return \Hbclare\ModelHelper\HelperQueryBuilder::setHelperModel($model);
        }
         ...
         * @static 
         */
        public static function getCacheQuery($columns){
            return \Hbclare\ModelHelper\HelperQueryBuilder::getCacheQuery($columns);
        }
         ...
         * @static 
         */
        public static function findWhereValue($value){
            return \Hbclare\ModelHelper\HelperQueryBuilder::findWhereValue($value);
        }
         ...
         * @static 
         */
        public static function findColumnsValue($keyName){
            return \Hbclare\ModelHelper\HelperQueryBuilder::findColumnsValue($keyName);
        }
        ...
        public static function findOne($where, $orderBy = array()){
            return \Hbclare\ModelHelper\HelperQueryBuilder::findOne($where, $orderBy);
        }
        ...
        public static function getOne($id){
            return \Hbclare\ModelHelper\HelperQueryBuilder::getOne($id);
        }
         ...
         * @static 
         */
        public static function getList($where, $orderBy = array(), $take = null, $skip = null, $fields = '*'){
            return \Hbclare\ModelHelper\HelperQueryBuilder::getList($where, $orderBy, $take, $skip, $fields);
        }
         ...
         * @static 
         */
        public static function getListUpgraded($where = array(), $predicate = array(), $fields = '*'){
            return \Hbclare\ModelHelper\HelperQueryBuilder::getListUpgraded($where, $predicate, $fields);
        }
         ...
         * @static 
         */
        public static function getPaginateList($where, $orderBy = array(), $pageNum = 20){
            return \Hbclare\ModelHelper\HelperQueryBuilder::getPaginateList($where, $orderBy, $pageNum);
        }
         ...
         * @static 
         */
        public static function getPaginateListUpgraded($where, $pageNum, $predicate, $fields = '*'){
            return \Hbclare\ModelHelper\HelperQueryBuilder::getPaginateListUpgraded($where, $pageNum, $predicate, $fields);
        }
         ...
         * @static 
         */
        public static function formatPredicate($predicate){
            return \Hbclare\ModelHelper\HelperQueryBuilder::formatPredicate($predicate);
        }
        ...
        public static function formatWhere($where){
            return \Hbclare\ModelHelper\HelperQueryBuilder::formatWhere($where);
        }
        ...
        public static function formatOrderBy($orderBy){
            return \Hbclare\ModelHelper\HelperQueryBuilder::formatOrderBy($orderBy);
        }
        ...
        public static function getCount($where, $field = '*'){
            return \Hbclare\ModelHelper\HelperQueryBuilder::getCount($where, $field);
        }
        ...
        public static function getSum($where, $field){
            return \Hbclare\ModelHelper\HelperQueryBuilder::getSum($where, $field);
        }
        ...
        public static function getMax($where, $field){
            return \Hbclare\ModelHelper\HelperQueryBuilder::getMax($where, $field);
        }
        ...
        public static function getMin($where, $field){
            return \Hbclare\ModelHelper\HelperQueryBuilder::getMin($where, $field);
        }
    ...
    class NewRedis extends \Illuminate\Support\Facades\Redis{
    ...
    class Linker extends \Common\Packages\Linker\LinkerFacade{
         ...
         * @static 
         */
        public static function set($name, $prefix){
            return \Common\Packages\Linker\Linker::set($name, $prefix);
        }
        
    }


    class Admin extends \Common\Packages\Admin\Facades\Admin{
         ...
         */
        public static function check(){
            return \Common\Packages\Admin\Guard::check();
        }
         ...
         */
        public static function guest(){
            return \Common\Packages\Admin\Guard::guest();
        }
        
        /**
         * 得到当前已授权用户
         *
         * @return null|\App\User|\Illuminate\Database\Eloquent\Model 
         * @static 
         */
        public static function user(){
            return \Common\Packages\Admin\Guard::user();
        }
         ...
         */
        public static function setUser($user){
            \Common\Packages\Admin\Guard::setUser($user);
        }
        
        /**
         * 临时登陆（不保存session或cookie）
         *
         * @param array $credentials
         * @return bool 
         * @static 
         */
        public static function once($credentials = array()){
            return \Common\Packages\Admin\Guard::once($credentials);
        }
         ...
         */
        public static function attempt($credentials = array(), $remember = false, $login = true){
            return \Common\Packages\Admin\Guard::attempt($credentials, $remember, $login);
        }
         ...
         * @static 
         */
        public static function basic($field = 'id'){
            return \Common\Packages\Admin\Guard::basic($field);
        }
        
        /**
         * 使用Http Basic进行一次验证（不支持）
         *
         * @param string $field
         * @static 
         */
        public static function onceBasic($field = 'id'){
            return \Common\Packages\Admin\Guard::onceBasic($field);
        }
         ...
         */
        public static function validate($credentials = array()){
            return \Common\Packages\Admin\Guard::validate($credentials);
        }
        
        /**
         * 用户登录
         *
         * @param \Common\Packages\Admin\UserContract $user
         * @param bool $remember
         * @static 
         */
        public static function login($user, $remember = false){
            return \Common\Packages\Admin\Guard::login($user, $remember);
        }
         ...
         */
        public static function loginUsingId($id, $remember = false){
            return \Common\Packages\Admin\Guard::loginUsingId($id, $remember);
        }
        
        /**
         * 判断用户是否通过“记住我”的cookie登陆
         *
         * @return mixed 
         * @static 
         */
        public static function viaRemember(){
            return \Common\Packages\Admin\Guard::viaRemember();
        }
         ...
         */
        public static function logout(){
            return \Common\Packages\Admin\Guard::logout();
        }
         ...
         */
        public static function getCookieJar(){
            return \Common\Packages\Admin\Guard::getCookieJar();
        }
         ...
         */
        public static function setCookieJar($cookie){
            \Common\Packages\Admin\Guard::setCookieJar($cookie);
        }
         ...
         */
        public static function getName(){
            return \Common\Packages\Admin\Guard::getName();
        }
        
        /**
         * 得到保存recaller的cookies名
         *
         * @return string 
         * @static 
         */
        public static function getRecallerName(){
            return \Common\Packages\Admin\Guard::getRecallerName();
        }
         ...
         */
        public static function getDispatcher(){
            return \Common\Packages\Admin\Guard::getDispatcher();
        }
         ...
         */
        public static function setDispatcher($events){
            \Common\Packages\Admin\Guard::setDispatcher($events);
        }
         ...
         */
        public static function getSession(){
            return \Common\Packages\Admin\Guard::getSession();
        }
        
    }


    class Curl extends \App\Support\CurlFacade{
        
        /**
         * 创建 curl 会话
         *
         * @param \App\Services\Common\type $url 页面url
         * 初始化url时将域名替换成ip访问，防止curl无法解析域名的问题
         * @static 
         */
        public static function setUrl($url){
            return \App\Services\Common\CurlService::setUrl($url);
        }
        
        /**
         * 单个配置 curl 参数
         *
         * @param \App\Services\Common\type $option 参数名称
         * @param \App\Services\Common\type $value 参数值
         * @return \App\Services\Common\type Object
         * @static 
         */
        public static function setOption($option, $value){
            return \App\Services\Common\CurlService::setOption($option, $value);
        }
        
        /**
         * 批量配置 curl 参数
         *
         * @param \App\Services\Common\type $options array()参数的名称和值分别存在数组的下标名称和值中
         * @return \App\Services\Common\type Object
         * @static 
         */
        public static function setOptions($options){
            return \App\Services\Common\CurlService::setOptions($options);
        }
        
        /**
         * 获得抓取到的页面信息
         *
         * @return \App\Services\Common\Sting 
         * @static 
         */
        public static function exec(){
            return \App\Services\Common\CurlService::exec();
        }
         ...
         */
        public static function close(){
            return \App\Services\Common\CurlService::close();
        }
         ...
         * @static 
         */
        public static function fetch($url = '', $timeout = 5, $times = 1){
            return \App\Services\Common\CurlService::fetch($url, $timeout, $times);
        }
         ...
         *
         * @param \App\Services\Common\type $url 页面url
         * @return \App\Services\Common\Array() 
         * @static 
         */
        public static function getCurlInfo($url = ''){
            return \App\Services\Common\CurlService::getCurlInfo($url);
        }
        
        /**
         * 模拟POST提交后抓取指定url的页面信息
         *
         * @param \App\Services\Common\type $postData Array() post提交数据
         * @param \App\Services\Common\type $url 页面url
         * @return \App\Services\Common\Sting 
         * @static 
         */
        public static function postCurl($url = '', $postData = '', $timeout = 5, $times = 1){
            return \App\Services\Common\CurlService::postCurl($url, $postData, $timeout, $times);
        }
        ...
        public static function checkVersion(){
            return \App\Services\Common\CurlService::checkVersion();
        }
